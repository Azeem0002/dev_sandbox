"""Hosting adapter for secure_login_5.
...
APP_NAME = "secure_login_5"
APP_KIND = "fastapi_api"
ENTRYPOINT = "secure_login_5.api:app"
APP_MODULE = ENTRYPOINT
HEALTH_PATH = "/health"
NEEDS_ALWAYS_ON = False
HOSTING_NOTE = "API auth service. Host behind HTTPS and set SECURE_LOGIN_JWT_SECRET."
