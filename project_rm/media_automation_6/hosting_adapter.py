"""Hosting adapter for media_automation_6.
...
APP_NAME = "media_automation_6"
APP_KIND = "fastapi_api_with_worker"
ENTRYPOINT = "media_automation_6.api:app"
APP_MODULE = ENTRYPOINT
HEALTH_PATH = "/health"
NEEDS_ALWAYS_ON = True
HOSTING_NOTE = "Automation needs an always-on process or an external scheduler for reliable posting checks."
