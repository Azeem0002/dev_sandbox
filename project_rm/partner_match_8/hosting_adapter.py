"""Hosting adapter for partner_match_8.
...
APP_NAME = "partner_match_8"
APP_KIND = "fastapi_api"
ENTRYPOINT = "partner_match_8.api:app"
APP_MODULE = ENTRYPOINT
HEALTH_PATH = "/health"
NEEDS_ALWAYS_ON = False
HOSTING_NOTE = "Single API backend for web/mobile/desktop clients; use managed Postgres before real launch."
