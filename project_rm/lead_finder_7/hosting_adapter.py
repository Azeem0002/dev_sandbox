"""Hosting adapter for lead_finder_7.
...
APP_NAME = "lead_finder_7"
APP_KIND = "fastapi_api"
ENTRYPOINT = "lead_finder_7.api:app"
APP_MODULE = ENTRYPOINT
HEALTH_PATH = "/health"
NEEDS_ALWAYS_ON = False
HOSTING_NOTE = "API can run on a simple web host; use a scheduler only after recurring scans are added."
