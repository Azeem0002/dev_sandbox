"""Tiny OS detection adapter for scheduler.

This isolates platform branching behind one reusable function so higher layers
do not scatter raw `os.name` / `sys.platform` checks.
"""
